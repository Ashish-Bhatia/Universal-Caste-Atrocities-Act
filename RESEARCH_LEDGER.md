...
The SC/ST Act and Rules baseline/extractions remain authoritative. The Rules clause extraction is complete with the Annexure-II source discrepancy preserved. The new section 3 BNS crosswalk is now recorded, covering section 3(1) conduct, section 3(2) aggravated offences, all 32 IPC references in the Act Schedule, transition through S.O. 2790(E)/GCA s.8/BNS s.358, and Rule 2(ga)'s IPC s.39 correspondence to BNS s.2(33). Final primary-text freeze and later-instrument completeness remain open. The next discrete workstream is the BNSS procedural crosswalk, followed by BSA evidence/presumption crosswalk. No Bill drafting or policy/constitutional conclusion has begun.
