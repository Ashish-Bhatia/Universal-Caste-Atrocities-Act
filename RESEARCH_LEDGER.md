...
| PH1-019 | SC/ST Rules clause extraction | Completed with qualification | A for underlying Government instruments; B/C for transcription aid | Principal Rules and amendment Gazettes; Department of Social Justice current publication index; consolidated India Code-derived text | Rules 1-18, all identified sub-rules, 47 Schedule relief items, Annexure-I and Annexure-II/attached disability material have been inventoried. Amendment provenance is linked to the identified 1995-2018 instruments. | Completed 2026-09-05; Annexure-II primary attachment identity remains open |
| PH1-020 | Rules current publication status | Verified as current-source indicator | A | Department of Social Justice and Empowerment current archive | Department site currently lists 1995 Rules plus separate 2016 and 2018 PoA Rules publications, with page last updated 22-06-2026. | Verified 2026-09-05; not treated as proof of absence of later Gazette instruments |
| PH1-021 | Rules Annexure-II source discrepancy | Open | A/B | Consolidated Rules transcription and Schedule item 43 citation | Schedule item 43 cites a 01-06-2001 disability notification, while attached Annexure-II material begins with a 06-08-1986 notification. These cannot be silently harmonised. | Primary-source resolution required |
...
The SC/ST Act has been extracted section-by-section from the India Code consolidation marked as on 21-09-2025. The identified SC/ST Rules amendment history through 2018 has been verified at instrument level. The consolidated Rules clause extraction is now recorded in `legislation/SCST_RULES_CLAUSE_EXTRACTION.md`, including Rules 1-18, sub-rules, 47 Schedule items, Annexure-I and Annexure-II structure. The principal unresolved Rules item is primary-source resolution of the Annexure-II disability attachment/reference discrepancy. The next discrete workstream is the SC/ST Act section 3 conduct-by-conduct BNS crosswalk, including the IPC-based Schedule, followed by BNSS/BSA crosswalks. Phase 1 remains open. No Bill drafting or policy/constitutional conclusion has begun.
