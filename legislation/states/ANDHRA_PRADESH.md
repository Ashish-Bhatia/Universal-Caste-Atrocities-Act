...
This record inventories Andhra Pradesh legislation, Rules, notifications/orders, schemes, SOPs, Special Courts, nodal/protection officers, prosecutors, monitoring committees and implementation machinery relevant to the SC/ST (Prevention of Atrocities) Act, 1989, the Protection of Civil Rights Act, 1955 and closely connected atrocity-interface laws.

This is a source inventory only. It does not assess necessity, superiority, policy desirability or constitutional validity.

## 1. State legislation and Rules

| Item | Finding | Evidence | Status |
|---|---|---|---|
| State Police / criminal-law framework | State Police machinery is evidenced through current district police administration pages. Specific State Police Act/Rules provisions affecting PoA implementation have not yet been extracted. | AP district government/police pages | OPEN |
| State-specific SC/ST PoA Rules | No separate Andhra Pradesh PoA Rules instrument was established in this first pass. The central 1995 Rules remain the primary Rules source pending a targeted State Gazette search. | Official AP and central sources | NOT FROZEN |
| PCR implementation rules/orders | State-specific material not yet fully extracted. | Official AP sources | OPEN |
| Other relevant State laws | Land, bonded labour, local government, public access and related interfaces require separate targeted screening. | State official repositories | OPEN |

## 2. Notifications and Government Orders
...
A named statewide PoA nodal officer was not established in the first official-source pass. Further searches must target current Social Welfare Department orders, Home Department orders, district Collectorate orders and Gazette notifications using the Rule 9 terminology and Andhra Pradesh administrative designations.

Status: OPEN.

## 5. Special Courts

A current statewide official consolidated list of Special Courts/Exclusive Special Courts for PoA matters was not established in this first pass. District judicial/collectorate and Government Orders require targeted extraction.
...
## 6. Special Public Prosecutors / prosecution machinery
...
## 7. Vigilance and Monitoring Committees

A current official district Social Welfare page for Sri Potti Sriramulu Nellore states that District Level and Sub-divisional Level Vigilance & Monitoring Committees are constituted and periodically review implementation of the Act. The same page states that the Social Welfare Department monitors implementation of the PoA Act in the district. [A]
...
## 9. SOPs, digital workflows and implementation records

No statewide PoA-specific SOP was established in the first pass. District-level administrative evidence shows operational coordination among police, revenue, Social Welfare and prosecution personnel. A targeted search is required for current SOPs, circulars, case-processing workflows, relief-sanction procedures, victim notification procedures and electronic monitoring systems.

Status: OPEN.

## 10. District-level implementation machinery
...
- bonded labour enforcement machinery;
- land assignment/alienation protections affecting SC/ST communities;
- Panchayats and Scheduled Areas/PESA where applicable;
- public-access and civil-rights enforcement;
- education/employment exclusion mechanisms where directly relevant.

## 12. Source register

| Source ID | Source | Date/currentness | Grade | Use |
|---|---|---|---|---|
| AP-STATE-001 | G.O.Ms.No.95, Social Welfare Department | 29-08-2016 | A | Relief/rehabilitation implementation |
| AP-STATE-002 | Sri Potti Sriramulu Nellore District, Social Welfare | Updated 2026 | A | Monitoring, committees, district implementation |
| AP-STATE-003 | Prakasam District Police | Updated 2026 | A | District SC/ST Cell evidence |
| AP-STATE-004 | YSR Kadapa District, SC ST Cell | Updated 2026 | A | District SC/ST Cell evidence |
| AP-STATE-005 | Anakapalli District Collectorate | Updated 2026 | A | Magisterial/atrocity case machinery |
| AP-STATE-006 | Nellore District Collectorate | Current official page | A | Law-and-order/revenue atrocity machinery |
| AP-STATE-007 | Vizianagaram District Government | 24-08-2022 | A | Special Public Prosecutor operational evidence |
| AP-STATE-008 | Ministry of Social Justice annual implementation reporting | Historical | B | Historical State implementation lead only |

## 13. First-pass conclusion

Andhra Pradesh has identifiable official evidence of district Social Welfare monitoring, district SC/ST police cells, district-level vigilance/monitoring activity, State relief implementation orders and district prosecution participation. The first pass does not yet establish a current statewide inventory of the State nodal officer, Protection Cell composition, Special/Exclusive Special Courts, Special Public Prosecutor appointments, current relief scheme consolidation, PoA-specific SOPs or State-level committee composition.

No absence claim is made for any unlocated instrument.

Next Andhra Pradesh task: targeted current official-source search for State nodal officer orders, State-level Protection Cell constitution, current Special/Exclusive Special Court notifications, Special Public Prosecutor appointments, State Vigilance and Monitoring Committee constitution, later relief orders, PoA-specific SOPs/circulars and State Gazette material.
