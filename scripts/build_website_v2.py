...
WEB.joinpath("states.html").write_text(shell("States & UTs","States & UTs",'<section class="page-intro"><span class="eyebrow">Jurisdiction research</span><h1>States & Union Territories</h1><p class="lead">Each completed jurisdiction has its own research page. Remaining jurisdictions are not represented as completed research.</p></section><section class="state-grid">'+"".join(f'<a class="state-card" href="states/{slug(n)}.html"><span class="chip">Research record</span><h3>{html.escape(n)}</h3><p>Implementation inventory and evidence.</p></a>' for n,_,_ in completed)+'</section>'),encoding="utf-8")
source_cards=[]
...
WEB.joinpath("law.html").write_text(shell("Existing Law","Existing Law",'<section class="page-intro"><span class="eyebrow">Legal framework</span><h1>Existing law</h1><p class="lead">Central-law research and interfaces relevant to the existing caste-atrocity framework.</p></section><section class="grid">'+"".join(law_cards)+'</section>'),encoding="utf-8")
WEB.joinpath("research.html").write_text(shell("Research","Research",'<section class="page-intro"><span class="eyebrow">Public research library</span><h1>Research by subject.</h1></section><section class="grid"><a class="card feature-card" href="states.html"><h3>State implementation</h3><p>Jurisdiction-specific evidence and implementation architecture.</p></a><a class="card feature-card" href="law.html"><h3>Existing law</h3><p>Acts, Rules and legal crosswalks.</p></a><a class="card feature-card" href="sources.html"><h3>Source evidence</h3><p>Controlled source provenance and verification status.</p></a></section>'),encoding="utf-8")
WEB.joinpath("methodology.html").write_text(shell("Methodology","Methodology",'<section class="page-intro"><span class="eyebrow">Research method</span><h1>Evidence and source control.</h1></section><section class="grid"><article class="card"><h3>Primary-source preference</h3><p>Constitutional text, legislation, Rules, Gazettes, Government orders, judgments, Parliament and official statistics are preferred.</p></article><article class="card"><h3>Evidence grades</h3><p>A is primary authoritative evidence. B is strong official or credible evidence. C is reliable secondary evidence. D is weak or unverified material.</p></article><article class="card"><h3>Source-ledger control</h3><p>The master ledger remains distinct from jurisdiction-specific ledgers. Fallback rows are explicitly labelled and never treated as master integrations.</p></article><article class="card"><h3>Currentness</h3><p>Historical reports remain tied to their reporting periods. Search silence is not treated as proof of legal absence.</p></article></section>'),encoding="utf-8")
