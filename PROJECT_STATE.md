...
PCA LATER-INSTRUMENT DEPENDENCY: ADVANCED WITH QUALIFICATION AFTER EXTENSION 14; Act 34 of 2019 and S.O. 1123(E), 18-03-2020 are verified primary instruments; the 31-05-2025 Central prosecution notification is now independently verified at indexed primary-source text level for date, subject, file number and operative omission, but its exact notification number, formal title and enabling provision remain unverified because the PDF endpoint returned HTTP 502.
...
2026-09-06: Controlled primary-source retrieval assessment completed for the 31-05-2025 PCA eGazette notification. The official eGazette result is independently indexed and reproduces operative text stating that the 2015 S.O. 8 notification's serial no. 4 and related entry were omitted. It also verifies the Gazette date, page 3521, file number F. No. 225/22/2015-AVD-II and signatory. Direct retrieval of the official PDF at `https://egazette.gov.in/WriteReadData/2025/264043.pdf` returned HTTP 502. The exact 2025 notification number, formal title and enabling provision therefore remain OPEN. PH1-ISSUE-008 remains OPEN and Phase 1 acceptance remains NOT YET SATISFIED. No PCA section 3 Special Judge census was performed.
